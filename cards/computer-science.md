...
- **How do you binary search an array?** Set two variables to the first and last indexes of the array. Calculate the midpoint the first and last. If the target
