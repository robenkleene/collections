...
- **How are search and insert into a binary tree similar?** They both compare the parameter value to the parameter node's value, and recurse into the left child if it's lower, otherwise into the right child.
