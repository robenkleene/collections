...
- **How do you binary search an array?** Set two variables to the start and end indexes of an array. Calculate the midpoint between the start and end. If the target is lower than the value at the midpoint, decrement the end by one.
